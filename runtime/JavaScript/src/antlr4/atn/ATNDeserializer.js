...
var _LexerAction = require("./LexerAction");

var LexerActions = _interopRequireWildcard(_LexerAction);
...
var ATNStates = _interopRequireWildcard(_ATNState);

var _ATNDeserializationOptions = require("./ATNDeserializationOptions");

var _IntervalSet = require("./../IntervalSet");

var _ATNType = require("./ATNType");
...
function ATNDeserializer(options) {
    ...
    if (options === undefined || options === null) {
        options = _ATNDeserializationOptions.ATNDeserializationOptions.defaultOptions;
    }
...
ATNDeserializer.prototype.deserialize = function (data) {
    ...
    this.verifyATN(atn);
    if (this.deserializationOptions.generateRuleBypassTransitions && atn.grammarType === _ATNType.ATNType.PARSER) {
...
ATNDeserializer.prototype.readATN = function () {
    ...
    return new _ATN.ATN(grammarType, maxTokenType);
};
...
ATNDeserializer.prototype.readRules = function (atn) {
    ...
    if (atn.grammarType === _ATNType.ATNType.LEXER) {
...
ATNDeserializer.prototype.readSets = function (atn, sets, readUnicode) {
    var m = this.readInt();
    for (var i = 0; i < m; i++) {
        var iset = new _IntervalSet.IntervalSet();
        sets.push(iset);
        var n = this.readInt();
...
ATNDeserializer.prototype.edgeFactory = function (atn, type, src, trg, arg1, arg2, arg3, sets) {
    ...
    switch (type) {
        ...
        case Transition.RANGE:
            return arg3 !== 0 ? new RangeTransition(target, _Token.Token.EOF, arg2) : new RangeTransition(target, arg1, arg2);
        ...
        case Transition.ATOM:
            return arg3 !== 0 ? new AtomTransition(target, _Token.Token.EOF) : new AtomTransition(target, arg1);
