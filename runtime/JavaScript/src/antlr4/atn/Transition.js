...
AtomTransition.prototype.makeLabel = function () {
  var s = new _IntervalSet.IntervalSet();
...
PredicateTransition.prototype.getPredicate = function () {
  return new _SemanticContext.Predicate(this.ruleIndex, this.predIndex, this.isCtxDependent);
};
...
function SetTransition(target, set) {
  ...
  if (set !== undefined && set !== null) {
    ...
    this.label = new _IntervalSet.IntervalSet();
    this.label.addOne(_Token.Token.INVALID_TYPE);
  }
  return this;
}
...
PrecedencePredicateTransition.prototype.getPredicate = function () {
  return new _SemanticContext.PrecedencePredicate(this.precedence);
};
